  ...
  return (
    <header className="bg-white shadow-md border-b border-gray-200 sticky top-0 z-50">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        {/* Hidden on mobile, flex on md (tablet/desktop) */}
        <div className="hidden md:flex flex-col items-end">
            <div className="flex items-center gap-1.5 bg-gradient-to-r from-blue-50 to-indigo-50 px-3 py-1.5 rounded-full border border-blue-100 mb-1">
                ...
                <span className="text-xs font-bold text-gray-700">
                    Designed by <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Bùi Minh Tuấn</span>
                </span>
            </div>
            <span className="text-[10px] text-gray-400 font-medium text-right max-w-md">
                Ứng dụng được tạo bởi Bùi Minh Tuấn - PR Tổng Công ty. Bản quyền thuộc về Tập đoàn MISA.
            </span>
        </div>
      </div>
    </header>
